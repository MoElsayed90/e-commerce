        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
               ...
               @if (session()->get('lang') == "ar")
                ...
                <a href="{{url("change/en")}}" style="text-decoration:none">English</a>
                </li>
               @else
                <li  li class="nav-item dropdown d-none d-lg-block p-5">
                <a href="{{url("change/ar")}}" style="text-decoration:none">العربية</a>
                </li>
              @endif
            <li class="nav-item dropdown d-none d-lg-block">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                <div class="navbar-profile">
                  ...
                  <a href="{{url("dashboard")}}">  <p class="d-none d-sm-block navbar-profile-name">Admin profile </p></a>
